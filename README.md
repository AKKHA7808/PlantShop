...
## เปิดเว็บไซต์จากโทรศัพท์ใน Wi-Fi เดียวกัน

1. เชื่อมต่อคอมพิวเตอร์และโทรศัพท์มือถือเข้ากับ Wi-Fi วงเดียวกัน
2. หา IP Address ของคอมพิวเตอร์ (IPv4) โดยพิมพ์คำสั่ง `ipconfig` ใน Command Prompt (Windows)
3. รัน Django ด้วยคำสั่ง:
   ```bash
   python manage.py runserver 0.0.0.0:8000
   ```
4. บนโทรศัพท์มือถือ ให้เปิดเบราว์เซอร์แล้วพิมพ์:
   `http://<COMPUTER_IP>:8000/`
   เช่น `http://192.168.1.100:8000/`
5. **หมายเหตุ:** ห้ามใช้ `http://127.0.0.1:8000/` หรือ `localhost` บนโทรศัพท์มือถือ เพราะมันจะหมายถึงตัวเครื่องโทรศัพท์เอง ไม่ใช่คอมพิวเตอร์ และอาจต้องกดยอมรับ Windows Firewall (Private networks) ให้ Python ด้วย
